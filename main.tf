...
resource "azurerm_storage_account" "priya2" {
  name                     = "priyastorageacct2"
  resource_group_name      = azurerm_resource_group.priya2.name
  location                 = azurerm_resource_group.priya2.location
  account_tier             = "Standard"
 account_replication_type = "LRS"
}